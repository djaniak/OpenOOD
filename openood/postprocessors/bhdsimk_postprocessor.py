...
class BhattacharyyaDistSimKPostprocessor(BasePostprocessor):
    def __init__(self, config):
        super(BhattacharyyaDistSimKPostprocessor, self).__init__(config)
    ...
    def postprocess(self, net: nn.Module, data: Any):
        ...
        for pm, pv in zip(mus, logvars):
            ...
            k_min_bh_dist = torch.sort(bh_dists)[0][self.K]
            conf.append(k_min_bh_dist)
